...
type NotifyFn = (opts: NotifyOptions | string, type?: NotifyOptions['type']) => void;
type TranslateFn = (key: string) => string | null;
...
declare const browserStorage: StorageAdapter;
